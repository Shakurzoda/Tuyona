import styles from "./BeautySalonsPage.module.css";
import ThumbsGallery from "../../Swiper/ThumbsGallery";
import { useParams } from "react-router";
import { BEAUTY_SALON } from "../CategoryPage/variables";

const BeautySalonsPage = () => {
  const { id } = useParams();
  const beautySalons = BEAUTY_SALON.find((item) => item.id === parseInt(id));

  return (
    <div className={styles.userAdDetails}>
      <div className={styles.userPhotoGallery}>
        <ThumbsGallery img={beautySalons.img} imgList={beautySalons.imgList} />
      </div>

      <div className={styles.userAdData}>
        <div className={styles.userAdData__title}>
          <p>{beautySalons.title}</p>
        </div>
        ...
        <div className={styles.userAdData__desc}>
          ...
          <div className={styles.userAdData__desc__body}>
            ...
            <div className={styles.userAdData__desc__body__data}>
              ...
              <a href={beautySalons.telLink} className={styles.userAdDataLink}>
                {beautySalons.tel}
              </a>
            </div>
      ...
      <div className={styles.userAdPricing}>
        <div className={styles.userAdPricing__price}>
          ...
          <p className={styles.price}>{beautySalons.price}</p>
        </div>

        <div className={styles.userAdSocialMedia}>
          <div className={styles.card}>
            <a
              href={beautySalons.instagram}
...
export default BeautySalonsPage;
