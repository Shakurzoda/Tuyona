...
import { PHOTOGRAPHERS } from "../CategoryPage/variables";

const RestaurantPage = () => {
  const { id } = useParams();
  const photographers = PHOTOGRAPHERS.find((item) => item.id === parseInt(id));

  return (
    <div className={styles.userAdDetails}>
      <div className={styles.userPhotoGallery}>
        <ThumbsGallery
          img={photographers.img}
          imgList={photographers.imgList}
        />
      </div>

      <div className={styles.userAdData}>
        <div className={styles.userAdData__title}>
          <p>{photographers.title}</p>
        </div>
        ...
        <div className={styles.userAdData__desc}>
          ...
          <div className={styles.userAdData__desc__body}>
            ...
            <div className={styles.userAdData__desc__body__data}>
              ...
              <a href={photographers.telLink} className={styles.userAdDataLink}>
                {photographers.tel}
              </a>
            </div>
      ...
      <div className={styles.userAdPricing}>
        <div className={styles.userAdPricing__price}>
          ...
          <p className={styles.price}>{photographers.price}</p>
        </div>

        <div className={styles.userAdSocialMedia}>
          <div className={styles.card}>
            <a
              href={photographers.instagram}
